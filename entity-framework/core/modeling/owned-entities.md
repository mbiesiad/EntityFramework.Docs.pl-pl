...
> [!NOTE]
> Przed EF Core 3,0 `WithOwner()` Metoda nie istnieje, więc należy usunąć to wywołanie. Ponadto klucz podstawowy nie został odnaleziony automatycznie, więc zawsze musiał być określony.
